...
import com.myassistant.phone_category.p_translate;

public class lang_translate extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ImageView button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(lang_translate.this, p_translate.class));
            }
        });

        Spinner sec_spinner = findViewById(R.id.sec_spinner);
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(lang_translate.this, R.array.spinner_item, R.layout.color_spinner_layout);
        adapter.setDropDownViewResource(R.layout.spinner_dropdown_layout);
        sec_spinner.setAdapter(adapter);
        sec_spinner.setOnItemSelectedListener(lang_translate.this);
    }
...
//            Toast.makeText(this, "English", Toast.LENGTH_SHORT).show();
        ...
        getSharedPreferences("MyP2", MODE_PRIVATE).edit().putString("name", String.valueOf(Utils.Language)).apply();
