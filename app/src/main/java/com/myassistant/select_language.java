...
public class select_language extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(select_language.this,category.class));
            }
        });

        Spinner sec_spinner = findViewById(R.id.sec_spinner);
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(select_language.this, R.array.spinner_item,R.layout.color_spinner_layout);
        adapter.setDropDownViewResource(R.layout.spinner_dropdown_layout);
        sec_spinner.setAdapter(adapter);
        sec_spinner.setOnItemSelectedListener(select_language.this);
...
//            Toast.makeText(this, "English", Toast.LENGTH_SHORT).show();
        ...
        getSharedPreferences("MyP",MODE_PRIVATE).edit().putString("name", String.valueOf(Utils.Language)).apply();
