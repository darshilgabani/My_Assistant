...
public class p_VtoT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pvtot);
        ...
        translate.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (ContextCompat.checkSelfPermission(com.myassistant.phone_category.p_VtoT.this, "android.permission.RECORD_AUDIO") == 0 || Build.VERSION.SDK_INT < 23) {
                    com.myassistant.phone_category.p_VtoT.this.speak_translate();
                } else if (ActivityCompat.shouldShowRequestPermissionRationale(com.myassistant.phone_category.p_VtoT.this, "android.permission.RECORD_AUDIO")) {
                    Snackbar.make(view, "This is main activity", Snackbar.LENGTH_LONG).setAction((CharSequence) "ENABLE", (View.OnClickListener) new View.OnClickListener() {
                        public void onClick(View view) {
                            ActivityCompat.requestPermissions(com.myassistant.phone_category.p_VtoT.this, new String[]{"android.permission.RECORD_AUDIO"}, 1);
                        }
                    }).show();
                } else {
                    ActivityCompat.requestPermissions(com.myassistant.phone_category.p_VtoT.this, new String[]{"android.permission.RECORD_AUDIO"}, 1);
